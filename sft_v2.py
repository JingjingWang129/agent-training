...
# 从第一次 SFT 的产物继续训练
TOKENIZER_PATH = PROJECT_ROOT / "final_model"
MODEL_PATH = PROJECT_ROOT / "sft_model"  # 第一次 SFT 的输出
DATA_PATH = PROJECT_ROOT / "data" / "training_samples.jsonl"  # 新的高质量数据集
OUTPUT_DIR = PROJECT_ROOT / "sft_checkpoints_v2"
FINAL_MODEL_DIR = PROJECT_ROOT / "sft_model_v2"
...
def print_config(dataset: Dataset, training_args: SFTConfig) -> None:
    print("\n========== 第二次 SFT Config ==========")
    print(f"模型路径: {MODEL_PATH} (从第一次 SFT 继续)")
